...
puts "==== HOLDINGS  ===== "
holdingsArray[0].each do |key, value|
  print key
  print ":  "
  print value
  print "\t\t-:-\t\t"
...
issuesArray[0].each do |key, value|
  print key
  print ":  "
  print value
  print "\t\t-:-\t\t"
...
ownersArray[0].each do |key, value|
  print key
  print ":  "
  print value
  print "\t\t-:-\t\t"
...
holdingsArray.each do |individalholding|
  Holding.create(
    ...
    filer: ownerObjectFilerIDHash[individalholding["filerid"].to_i],
